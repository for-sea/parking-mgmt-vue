<template>
  <div>
    <el-alert title="两次输入新密码不一致" type="error" center show-icon v-show="errorVisiable"></el-alert>
    <!-- 个人信息 -->
              ...
              <el-row :gutter="20">
                <el-col :span="12" :offset="0">
                  <el-form-item label="用户名" prop="username">
                    <el-input auto-complete="off" v-model.trim="updateUserDTO.username" placeholder="请输入新用户名"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12" :offset="0">
                  <el-form-item label="手机号" prop="phone">
                    <el-input auto-complete="off" v-model.trim="updateUserDTO.phone" placeholder="请输入新手机号"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="12" :offset="0">
                  <el-form-item label="车牌号" prop="license">
                    <el-input maxlength="18" v-model.trim="updateUserDTO.license" placeholder="请输入新车牌号"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12" :offset="0">
                  <el-form-item label="密码" prop="password">
                    <el-input type="password" maxlength="18" v-model.trim="updateUserDTO.password" placeholder="请输入密码"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="12" :offset="0">
                  <el-form-item label="新密码" prop="newPassword">
                    <el-input type="password" maxlength="15" v-model.trim="updateUserDTO.newPassword" placeholder="请输入新密码"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12" :offset="0">
                  <el-form-item label="re新密码" prop="newPassword">
                    <el-input type="password" maxlength="15" v-model.trim="updateUserDTO.reNewPassword" placeholder="请再次输入新密码"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
            <div slot="footer" class="dialog-footer">
              <el-button size="mini" type="primary" @click="onSubmit" :plain="true">提交</el-button>
...
export default {
  ...
  methods: {
    ...
    // 校验新密码
    checkNewPasssword() {
      if (this.updateUserDTO.newPassword != '' && this.updateUserDTO.newPassword != this.updateUserDTO.reNewPassword) {
